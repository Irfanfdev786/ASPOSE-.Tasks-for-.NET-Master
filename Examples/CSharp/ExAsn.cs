namespace Aspose.Tasks.Examples.CSharp
{
    ...
    public class ExAsn : ApiExampleBase
    {
        ...
        [Test]
        public void SetResourceAssignmentCosts()
        {
            // ExStart:AutoCalculateAssignmentCosts
            // ExFor: Prj.AutoCalculateAssignmentCosts
            // ExFor: Project.AutoCalculateAssignmentCosts
            // ExSummary: Shows how to turn of auto calculation of assignment's costs and to set assignment's costs explicitly.
            var project = new Project();
            ...
            Console.WriteLine("Remaining Cost: {0}", assignment.RemainingCost);
            Console.WriteLine("Cost: {0}", assignment.Cost);
            // ExEnd:AutoCalculateAssignmentCosts
        }
