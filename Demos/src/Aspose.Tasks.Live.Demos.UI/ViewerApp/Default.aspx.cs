...
namespace Aspose.Tasks.Live.Demos.UI.ViewerApp
{
	public partial class Default : BasePage
	{
        ...
        protected void Page_Load(object sender, EventArgs e)
		{
			if (!IsPostBack)
			{
                ...
                apiUrl = Configuration.AsposeTasksLiveDemosPath;

                Page.Title = Resources["tasksViewerPageTitle"];
				Page.MetaDescription = Resources["tasksViewerMetaDescription"];
			}
		}
