...
namespace Aspose.Tasks.Live.Demos.UI.Config
{
    ...
    {
        private AsposeTasksContext _atContext;
        ...
        public AsposeTasksContext AsposeTasksContext
		{
            get
            {
                if (_atContext == null) _atContext = new AsposeTasksContext(HttpContext.Current);
                return _atContext;
            }
        }
		...
		protected override void OnLoad(EventArgs e)
        {
			...
			AsposeTasksContext.atcc = AsposeTasksContext;
            base.OnLoad(e);
        }
    }
}
