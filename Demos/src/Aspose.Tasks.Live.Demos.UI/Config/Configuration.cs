...
namespace Aspose.Tasks.Live.Demos.UI.Config
{
	...
	{		
		...
		private static string _asposeTasksLiveDemosPath = ConfigurationManager.AppSettings["AsposeTasksLiveDemosPath"].ToString();
		...
		private static string _asposeTasksAppsAssetURL = ConfigurationManager.AppSettings["AsposeTasksAppsAssetURL"];
		...
		public static string AsposeTasksAppsAssetURL
		{
			get { return _asposeTasksAppsAssetURL; }
		}	
        ...
        public static string AsposeTasksLiveDemosPath
        {
            get { return _asposeTasksLiveDemosPath; }
        }
